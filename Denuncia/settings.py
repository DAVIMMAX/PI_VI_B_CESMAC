...
SECRET_KEY = 'django-insecure-)1ws@8&^h!kf^f)mi(t6swvw8)58a@tmosos73l_k&&rz+y!+w'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Diretório onde os arquivos estáticos são armazenados
